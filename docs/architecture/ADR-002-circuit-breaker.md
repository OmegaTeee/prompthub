...
## Context
PromptHub routes requests between clients and multiple downstream services (MCP servers, LM Studio). When downstream services fail or become slow, we need to:
