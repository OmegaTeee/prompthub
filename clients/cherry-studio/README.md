...
`cherry-studio` is the repo/client identifier for Cherry Studio. Cherry Studio
is a **dual-mode** PromptHub client:
...
AUTHORIZATION=Bearer sk-prompthub-cherry-studio-001
...
| API Key | `sk-prompthub-cherry-studio-001` |
