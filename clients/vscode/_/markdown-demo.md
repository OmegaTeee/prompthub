# [GitHub Markdown CSS demo](#github-markdown-css-demo)
...
Install VS Code plugin [davidmwhynot.markdown-higlightjs](https://marketplace.visualstudio.com/items?itemName=davidmwhynot.markdown-higlightjs)
...
## [Inline HTML](#inline-html-1)

You can also use raw HTML in your Markdown[1](#user-content-fn-1), and it'll mostly work pretty well[2](#user-content-fn-2).
...
[\[test\]:](`javascript:void(null)`) [http://google.com/](https://google.com/) "Google"
...
Hello *world*. Here is a [link](//hello). And an image [![alt](/tylerlong/github-markdown-css-demo/raw/master/src)](/tylerlong/github-markdown-css-demo/blob/master/src).
...
which will render in a browser as a clickable link to "[\[email protected\]](/cdn-cgi/l/email-protection#d8b9bcbcaabdabab98bda0b9b5a8b4bdf6bbb7b5)".
...
Here's an example of footnotes in action. This paragraph contains multiple footnote references[3](#user-content-fn-3) to demonstrate how they appear in GitHub-style Markdown[4](#user-content-fn-4).

## Footnotes

1. HTML elements like `<em>` and `<strong>` are supported natively. [↩](#user-content-fnref-1)
2. Though there are some limitations compared to pure Markdown syntax. [↩](#user-content-fnref-2)
3. Footnotes are automatically numbered and linked back to their references. [↩](#user-content-fnref-3)
4. GitHub's Markdown processor generates this exact HTML structure for footnotes. [↩](#user-content-fnref-4)
