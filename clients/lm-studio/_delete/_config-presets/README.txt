...
- `Qwick-Assistant.preset.json`
- `Qwick-Assistant-No-Think.preset.json`
...
- `Qwick-Assistant-No-Think.preset.json` references `../prompt_templates/qwick-text-editor.txt` by name and
