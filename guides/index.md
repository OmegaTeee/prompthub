...
4. **[Claude Desktop Integration](claude-desktop-integration.md)** - Connect Claude Desktop
5. **[VS Code Integration](vscode-integration.md)** - Connect VS Code / Cline / Claude Code
6. **[Raycast Integration](raycast-integration.md)** - Connect Raycast launcher

**Finally, test everything works:**

7. **[Testing Integrations](testing-integrations.md)** - Comprehensive test suite
