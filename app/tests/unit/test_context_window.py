...
class TestModelRegistry:
    ...
    def test_register_model_overwrites_existing(self):
        original = MODEL_CONTEXT_TOKENS.get("qwen3-4b-instruct-2507")
        register_model("qwen3-4b-instruct-2507", 999)
        assert MODEL_CONTEXT_TOKENS["qwen3-4b-instruct-2507"] == 999
        # Restore
        MODEL_CONTEXT_TOKENS["qwen3-4b-instruct-2507"] = original
...
class TestTokenBudgetFormula:
    def test_available_capped_at_enhancement_input_cap(self):
        ...
        b = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=100, system_prompt="")
    ...
    def test_system_prompt_reduces_budget(self):
        ...
        b_short = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=500, system_prompt=short_system)
        b_long = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=500, system_prompt=long_system)
    ...
    def test_available_chars_matches_tokens(self):
        b = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=500, system_prompt="")
...
class TestSummary:
    def test_summary_contains_all_keys(self):
        b = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=500, system_prompt=SAMPLE_SYSTEM)
        s = b.summary()
        expected_keys = {
            "model",
    ...
    def test_summary_values_are_consistent(self):
        b = TokenBudget(model="qwen3-4b-instruct-2507", max_response_tokens=500, system_prompt=SAMPLE_SYSTEM)
        s = b.summary()
        assert s["model"] == "qwen3-4b-instruct-2507"
